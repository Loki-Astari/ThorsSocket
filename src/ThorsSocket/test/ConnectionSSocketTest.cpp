...
TEST(ConnectionSSocketTest, Read_SSL_ERROR_WANT_WRITE)                {testReadFailureException<std::runtime_error>(SSL_ERROR_WANT_WRITE);}
TEST(ConnectionSSocketTest, Read_SSL_ERROR_WANT_CONNECT)              {testReadFailureException<std::runtime_error>(SSL_ERROR_WANT_CONNECT);}
TEST(ConnectionSSocketTest, Read_SSL_ERROR_WANT_ACCEPT)               {testReadFailureException<std::runtime_error>(SSL_ERROR_WANT_ACCEPT);}
TEST(ConnectionSSocketTest, Read_SSL_ERROR_SYSCALL)                   {testReadFailureException<std::runtime_error>(SSL_ERROR_SYSCALL);}
TEST(ConnectionSSocketTest, Read_SSL_ERROR_SSL)                       {testReadFailureException<std::runtime_error>(SSL_ERROR_SSL);}
TEST(ConnectionSSocketTest, Read_SSL_ERROR_WANT_X509_LOOKUP)          {testReadFailureException<std::runtime_error>(SSL_ERROR_WANT_X509_LOOKUP);}
TEST(ConnectionSSocketTest, Read_SSL_ERROR_WANT_CLIENT_HELLO_CB)      {testReadFailureException<std::runtime_error>(SSL_ERROR_WANT_CLIENT_HELLO_CB);}
TEST(ConnectionSSocketTest, Read_SSL_ERROR_WANT_ASYNC)                {testReadFailureException<std::runtime_error>(SSL_ERROR_WANT_ASYNC);}
TEST(ConnectionSSocketTest, Read_SSL_ERROR_WANT_ASYNC_JOB)            {testReadFailureException<std::runtime_error>(SSL_ERROR_WANT_ASYNC_JOB);}
...
TEST(ConnectionSSocketTest, Write_SSL_ERROR_WANT_READ)                {testWriteFailureException<std::runtime_error>(SSL_ERROR_WANT_READ);}
TEST(ConnectionSSocketTest, Write_SSL_ERROR_WANT_CONNECT)             {testWriteFailureException<std::runtime_error>(SSL_ERROR_WANT_CONNECT);}
TEST(ConnectionSSocketTest, Write_SSL_ERROR_WANT_ACCEPT)              {testWriteFailureException<std::runtime_error>(SSL_ERROR_WANT_ACCEPT);}
TEST(ConnectionSSocketTest, Write_SSL_ERROR_SYSCALL)                  {testWriteFailureException<std::runtime_error>(SSL_ERROR_SYSCALL);}
TEST(ConnectionSSocketTest, Write_SSL_ERROR_SSL)                      {testWriteFailureException<std::runtime_error>(SSL_ERROR_SSL);}
TEST(ConnectionSSocketTest, Write_SSL_ERROR_WANT_X509_LOOKUP)         {testWriteFailureException<std::runtime_error>(SSL_ERROR_WANT_X509_LOOKUP);}
TEST(ConnectionSSocketTest, Write_SSL_ERROR_WANT_CLIENT_HELLO_CB)     {testWriteFailureException<std::runtime_error>(SSL_ERROR_WANT_CLIENT_HELLO_CB);}
TEST(ConnectionSSocketTest, Write_SSL_ERROR_WANT_ASYNC)               {testWriteFailureException<std::runtime_error>(SSL_ERROR_WANT_ASYNC);}
TEST(ConnectionSSocketTest, Write_SSL_ERROR_WANT_ASYNC_JOB)           {testWriteFailureException<std::runtime_error>(SSL_ERROR_WANT_ASYNC_JOB);}
